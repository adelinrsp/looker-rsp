...
const ALLOWED_SALESPERSONS = ['PIERRE', 'MORGAN', 'LAURENT', 'JEAN CHRISTOPHE', 'VINCENT'];
...
const SALESPERSON_COLORS: Record<string, { bg: string; text: string; border: string; dot: string }> = {
  ...
  'JEAN CHRISTOPHE': { bg: 'bg-violet-50/50', text: 'text-violet-700', border: 'border-violet-100', dot: 'bg-violet-500' },
  'VINCENT': { bg: 'bg-rose-50/50', text: 'text-rose-700', border: 'border-rose-100', dot: 'bg-rose-500' },
